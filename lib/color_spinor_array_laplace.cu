...
namespace quda {
  ...
  struct LaplaceArg {
    ...
    LaplaceArg(ColorSpinorArray &out, const ColorSpinorArray &in, const GaugeField &U,
           Float kappa, const ColorSpinorArray *x, int parity)
...
#pragma unroll
  ...
  public:
    Laplace(Arg &arg, const ColorSpinorArray &meta) : TunableVectorY(arg.nParity), arg(arg), meta(meta)
    {
  ...
  template <typename Float, int nColor, QudaReconstructType recon>
    void ApplyLaplace(ColorSpinorArray &out, const ColorSpinorArray &in, const GaugeField &U,
              double kappa, const ColorSpinorArray *x, int parity)
  {
